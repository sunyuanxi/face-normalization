...
flags.DEFINE_float('lambda_t', 1, 'weight of the loss for supervised part') #(added)
...
# For training
flags.DEFINE_integer('dataset_size', 51950, 'number of non-normal face set')
#flags.DEFINE_string('profile_path', '../Data/CASIA-WebFace/', 'dataset path')  # casia_aligned_250_250_jpg
#flags.DEFINE_string('profile_list', '../Data/CASIA-WebFace/profile_list.txt', 'train profile list')
flags.DEFINE_string('profile_path', '../Data/c_Multi-PIE/profile_list/', 'dataset path')  # casia_aligned_250_250_jpg
flags.DEFINE_string('profile_list', '../Data/c_Multi-PIE/profile_list/profile_list.txt', 'train profile list')
flags.DEFINE_string('front_path', '../Data/c_Multi-PIE/front_list/', 'front data path')
flags.DEFINE_string('front_list', '../Data/c_Multi-PIE/front_list/front_list.txt', 'train front list')
flags.DEFINE_string('test_path', '../Data/c_Multi-PIE/test_list/', 'front data path')
flags.DEFINE_string('test_list', '../Data/c_Multi-PIE/test_list/test_list.txt', 'train front list')
...
flags.DEFINE_integer('ori_height', 250, 'original height of profile images')
flags.DEFINE_integer('ori_width', 250, 'original width of profile images')
